<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/admin/admin-layout.Master" AutoEventWireup="true" CodeBehind="urun-ekle.aspx.cs" Inherits="WebApplication1.Yonetim.admin.urun_guncelle" %>
    ...
    <div class="urun-container">
        ...
        <div>
            <formview action="/action_page.php">
                ...
                <asp:DropDownList ID="DdlAltKategori" runat="server" DataSourceID="AltKategori" DataTextField="AltKategoriAdi" DataValueField="AltKategoriId">
                </asp:DropDownList>
                ...
                <!---->
                <br />
                <label for="lname">Ürün Kodu</label>
                <asp:TextBox ID="TbUrunKodu" runat="server" type="text" placeholder="Ürün Kodu" class="a" name="firstname"></asp:TextBox>
                ...
                <asp:Button CssClass="w3-btn w3-ripple w3-green btn-urun" ID="urunEkle" runat="server" Text="Ürün Ekle" OnClick="urunEkle_Click" />
